...
\caption{Schéma de principe d'un propulseur à effet Hall. Le champ électrique axial $\vec{E}$ accélère les ions vers la sortie, tandis que le champ magnétique radial $\vec{B}$ piège les électrons dans une dérive azimutale (courant de Hall), maximisant l'ionisation du xénon.}
